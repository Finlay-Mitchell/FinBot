...
class Paginator:
    def __init__(self, bot: FinBot, channel: discord.TextChannel, title=None, full_text=None, caller=None):
    ...
    async def start(self):
        self.fill_pages()
        self.message = await self.channel.send(self.pages[self.page_index])
